...
const ADD_CATEGORY = `${CATEGORY_URL}/add`;
const UPDATE_CATEGORY = `${CATEGORY_URL}/update`;
const GET_CATEGORY_FETCH_ALL = `${CATEGORY_URL}/fetch/all`;
const DELETE_CATEGORY_BY_ID = `${CATEGORY_URL}/delete?categoryId=`;
...
const GET_PRODUCT_FETCH_CATEGORY_WISE = `${PRODUCT_URL}/fetch/category-wise?categoryId=`;
...
const GET_PRODUCT_FETCH_SELLER_WISE_CATEGORY_WISE = `${PRODUCT_URL}/fetch/seller-wise/category-wise?sellerId=`;
...
const PRODUCT_BY_ID_CATEGORY = `${PRODUCT_URL}/`;
...
export {
  ...
  GET_PRODUCT_FETCH_CATEGORY_WISE,
  GET_PRODUCT_BY_ID,
  PRODUCT_ADD,
  ...
  GET_PRODUCT_FETCH_SELLER_WISE_CATEGORY_WISE,
  ADD_PRODUCT_REVIEW,
  GET_PRODUCT_REVIEWS_BY_ID,
  PRODUCT_IMAGE_BASE,
  PRODUCT_BY_ID_CATEGORY,
  USER_ADMIN_REGISTER,
  USER_LOGIN,
  USER_REGISTER,
